...
export class StatusBarManager {
    ...
    createStatusBarItems(): void {
        ...
        this.statusBarItems = {
            configure: vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 25),
            platform: vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 24),
            project: vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 23),
            buildType: vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 22),
            separator: vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 21),
            init: vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 20),
            update: vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 19),
            search: vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 18),
            install: vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 17),
            autoremove: vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 16),
            create: vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 15),
            clean: vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 14),
            reverse: vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 13),
            tree: vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 12),
            version: vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 11)
        };

        // Configure button (leftmost)
        ...
        // Init
        this.statusBarItems.init.text = '$(repo-clone) Init';
        ...
        // Clean
        this.statusBarItems.clean.text = '$(trash) Clean';
        ...
        // Reverse
        this.statusBarItems.reverse.text = '$(arrow-swap) Reverse';
        ...
        // Tree
        this.statusBarItems.tree.text = '$(list-tree) Tree';
        ...
        // Version
        this.statusBarItems.version.text = '$(info) Version';
        ...
        this.statusBarItems.create.text = '$(new-file) Create';
        ...
        this.statusBarItems.install.text = '$(build) Install';
        ...
        // Auto Remove
        this.statusBarItems.autoremove.text = '$(trash) Autoremove';
